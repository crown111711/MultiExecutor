...
public class MultiExecutorTest {
    public static void main(String[] args) {
        ...
        pools.add(pool4);
        // 使用两级线程池关联各个业务线程池
        MultiExecutor.register(new ThreadPoolExecutor(20, 30, 0L, TimeUnit.MILLISECONDS, new ArrayBlockingQueue<Runnable>(10)), pools);
    ...
    public static class PrintLogRejectHandler implements RejectedExecutionHandler {
        private String tag;
